...
//  };
	...
	let tbl_1 = u8x8::new(0x00, 0x1b, 0x36, 0x2d, 0x6c, 0x77, 0x5a, 0x41, );
	let tbl_2 = u8x8::new (0xd8, 0xc3, 0xee, 0xf5, 0xb4, 0xaf, 0x82, 0x99, );
	let u4_0x11b_mod_table = u8x8x2::new ( tbl_1, tbl_2 );
